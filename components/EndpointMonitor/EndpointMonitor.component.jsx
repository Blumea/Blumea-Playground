  ...
  return (
    <div className='my-8 bg-white p-3 rounded-lg drop-shadow-md flex justify-between'>
      <div className='flex gap-2'>
        ...
        <span className='text-warning font-semibold'>{actionType === 'create' ? 'POST' : 'GET'} | </span>
      ...
      <div className='flex gap-2'>
        ...
        <span className={`${statusCode === 200 || statusCode === 201 ? `text-success` : `text-failure`} font-semibold`}>{statusCode} {statusCode === 200 || statusCode === 201 ? 'OK':'ERROR'}</span>
      </div>
    </div>
  )
}
