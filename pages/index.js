...
const HomePage = ({ ResponseFromHome }) => {
  return (
    <div className='grid grid-cols-contentColumnGrid pt-4 font-inter mx-4'>
      ...
      <div className='border-r mt-4 p-3'>
        ...
        <div className='my-4'>
          <select
            id='large'
            class='drop=shadow-md block w-full px-4 py-3 text-base text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500'
          >
            <option selected>Choose a varient</option>
        ...
        <button
          type='button'
          class='drop-shadow-lg gap-3 text-white bg-[#2557D6] hover:bg-[#2557D6]/90 focus:ring-4 focus:ring-[#2557D6]/50 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#2557D6]/50 mr-2 mb-2 w-full my-8 justify-center'
        >
          <svg
            xmlns='http://www.w3.org/2000/svg'
            fill='none'
      ...
      <div className='mt-4'>
        ...
        <div className='h-96 bg-white mt-8 drop-shadow-md rounded-lg p-10'>
          {ResponseFromHome.message}
        </div>
      </div>
    </div>
  )
...
export async function getServerSideProps() {
  ...
  const ApiHome = 'https://blumea-serverless.vercel.app/api/home'
